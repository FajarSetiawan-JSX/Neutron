...
<template>
    <div
        class="group overflow-hidden rounded-3xl bg-[#151515] shadow-xl transition-all duration-300 hover:-translate-y-1 hover:shadow-red-500/10"
    >
        <!-- Cover -->
        <div class="relative h-52 overflow-hidden">
            <img
                :src="'https://picsum.photos/600/400?random=room'"
                class="h-full w-full object-cover"
            />

            <div
                class="absolute inset-0 bg-gradient-to-t from-[#151515] via-[#151515]/30 to-transparent"
            />
            ...
            <div class="absolute right-4 top-4">
                <button
                    ...
                    class="rounded-full bg-black/50 p-2 text-white backdrop-blur transition hover:bg-black/70"
                >
            ...
            <div
                class="absolute bottom-4 right-4 flex items-center gap-2 rounded-full bg-black/50 px-3 py-1 text-sm text-white backdrop-blur"
            >
                <Users class="h-4 w-4" />
                {{ kelas.siswa }}
            </div>
        ...
        <div class="space-y-5 p-5">
            ...
            <div class="flex items-end justify-between">
                <div>
                    ...
                    <div
                        class="mt-1 flex h-8 w-8 items-center justify-center rounded-full bg-white/15"
                    >
