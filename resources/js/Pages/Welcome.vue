...
<template>
    ...
    <div class="bg-gray-50 text-black/50">
        <div class="relative p-10 md:p-20 flex min-h-screen flex-col selection:bg-[#FF2D20] selection:text-white">
            <div class="p-3.5 grid grid-cols-1 md:grid-cols-2 gap-5">
                <div>
                    <div class="h-64 w-full">
                        ...
                        <HyperText text="Sokaraja" :duration="1000" :delay="2000" class="text-6xl font-bold font-anonymous text-white" />
                    </div>
            ...
            <section class="my-5">
                ...
                <form v-if="show" @submit.prevent="submit" class="my-2.5 max-w-max mx-auto">
                    ...
                    <Transition name="item">
                        <button v-if="showButton" type="submit" class="w-full bg-red-500 hover:bg-red-600 focus:scale-90 transition-all duration-300 py-2 rounded-lg text-center text-white font-anonymous">Sign In</button>
                    </Transition>
                </form>
            </section>
            
            <footer class="absolute bottom-3.5 text-slate-800 text-center text-xs">
